...
SET_MEMORY_MAP:
	...
	mov esi, 0; memory map size count
;;;;;;;;;;;;;S;;;;;;;;;;;;;;;;;
MEMORY_MAP_LOOP:
	mov eax, 0x0000e820
	mov edx, 0x534d4150
	...
	jc MEMORY_MAP_LOOP_PUSH_MINUS_ONE
	add esi, ecx ; ecx holds the length returned in bytes
	...
	jmp MEMORY_MAP_LOOP
MEMORY_MAP_LOOP_PUSH_MINUS_ONE:
	push -1
	jmp MEMORY_MAP_LOOP_END
MEMORY_MAP_LOOP_PUSH_ONE:
	push 1
	mov dword [MEMORY_MAP_SIZE_LOCATION], esi
;;;;;;;;;;;;;E;;;;;;;;;;;;;;;;;
MEMORY_MAP_LOOP_END:
	add sp, 2
	popad
